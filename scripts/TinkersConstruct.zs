...
furnace.addRecipe(<RotaryCraft:rotarycraft_item_compacts:7>,<ore:oreSilver>);
furnace.addRecipe(<RotaryCraft:rotarycraft_item_compacts:7>,<RotaryCraft:rotarycraft_item_modextracts:19>);
